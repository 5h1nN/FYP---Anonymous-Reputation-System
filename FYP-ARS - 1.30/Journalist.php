			...
			foreach ($list_of_reports as $report){
				...
				print '<tr>
					...
					<td align="center" style="word-wrap:break-word;">
						...
						<br />
						<br />						
						<input id="sign" type="button" value="2" onclick="sign(\''.$report["blind_message"].'\',\''.$report["TrustLevel"].'\',\'2\')" class="btn btn-success" style="width: 100px;"/>			
						<br />
						<br />
						<input id="sign" type="button" value="3" onclick="sign(\''.$report["blind_message"].'\',\''.$report["TrustLevel"].'\',\'3\')" class="btn btn-success" style="width: 100px;"/>			
						<br />
						<br />
						<input id="sign" type="button" value="4" onclick="sign(\''.$report["blind_message"].'\',\''.$report["TrustLevel"].'\',\'4\')" class="btn btn-success" style="width: 100px;"/>			
						<br />
						<br />
						<input id="sign" type="button" value="5" onclick="sign(\''.$report["blind_message"].'\',\''.$report["TrustLevel"].'\',\'5\')" class="btn btn-success" style="width: 100px;"/>
						<br />
						<br />																						
