...
<html>
  <meta charset="UTF-8">
 <title>Journalist Portal</title>
<!-- stylesheet -->
<link rel="stylesheet" href="https://192.168.1.1/FYP-ARS-Journalist/style/Journalist/bootstrap.min.js">

<!-- jquery -->
<script src="https://192.168.1.1/FYP-ARS-Journalist/lib/jquery-1.8.3.min.js"></script>

<!-- library for decoding the certificates -->
<script src="https://192.168.1.1/FYP-ARS-Journalist/bin/jsencrypt.min.js"></script>

<!-- library for the math -->
<script src="https://192.168.1.1/FYP-ARS-Journalist/lib/jsbn/jsbn.js" ></script>
<script src="https://192.168.1.1/FYP-ARS-Journalist/lib/jsbn/jsbn2.js" ></script>

<!-- library md5.js -->
<script src="https://192.168.1.1/FYP-ARS-Journalist/scripts/md5.js"></script>

<!-- Customized library for signing the blind signature -->
<script src="https://192.168.1.1/FYP-ARS-Journalist/scripts/Journalist.js"></script>

<body onload="validateToken()" background="https://192.168.1.1/FYP-ARS-Journalist/images/background5.jpg">
...
<div align="center" class="container"> <!-- start of main container-->
    ...
    <h3>---- List of all the reports ----</h3><br/>
	...
	<?php 
		...
		if(!empty($list_of_reports)){
			print '<tr><th>Index</th><th>Text</th><th>Blind Message</th><th>Token</th><th>Previous r</th><th>Trust Level</th><th>Action <br/>(Number indicate the trust level to be assigned)</th></tr>';	
			...
			foreach ($list_of_reports as $report){
				...
				print '<tr>
					...
					<td style="word-wrap:break-word;" id="validitybox'.$index.'">'.$report["TrustLevel"].'<input type="hidden" id="validity'.$index.'" class="form-control" value="'.$report["TrustLevel"].'" />
						<input type="hidden" class="prev_pubkey form-control" value="'.$report["prev_pubkey"].'" />
					</td>										
