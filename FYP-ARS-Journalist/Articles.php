...
<html>
  <meta charset="UTF-8">
 <title>Articles/Tokens Portal</title>

<!-- stylesheet -->
<link rel="stylesheet" href="https://192.168.1.1/FYP-ARS-Journalist/style/Articles/bootstrap.min.js">

<!-- jquery -->
<script src="https://192.168.1.1/FYP-ARS-Journalist/lib/jquery-1.8.3.min.js"></script>

<!-- library for decoding the certificates -->
<script src="https://192.168.1.1/FYP-ARS-WhistleBlower/bin/jsencrypt.min.js"></script>

<!-- library for the math -->
<script src="https://localhost/FYP-ARS-WhistleBlower/lib/jsbn/jsbn.js" ></script>
<script src="https://localhost/FYP-ARS-WhistleBlower/lib/jsbn/jsbn2.js" ></script>

<!-- Customized library for creating the token -->
<script src="https://localhost/scripts/Articles.js"></script>

<!-- library md5.js -->
<script src="https://localhost/scripts/md5.js"></script>

<body onload="setValues()" background="https://localhost/FYP-ARS-WhistleBlower/images/background5.jpg">
  <div class="container">
